...
function JPday(date,t)
  ...
  date= string.gsub(date, "%%VW",local_day[tonumber(os.date("%w",t))+1].."曜日") 
...
function script_properties()
	...
	obs.obs_properties_add_text(props, "ga", "6.学園アイマス", obs.OBS_TEXT_DEFAULT)
...
if(sel=="ga")then
for i=1,stlen do
if((imasb["ga"][i][2]..imasb["ga"][i][3]):match(s))then
return i
end
end
end
