...
--,{"ミリシタ海外版","2019-08-29T15:00:00.000Z","iOS、Android",""
  ...
  local aniv=lefttime(imasb[imassel[imass]][useidol][1])
  local gm = "誕生日" 
  if(aniv<0) then
  aniv =-aniv
  gm = gm.."から"
  ...
  local ep= string.gsub(get_ep(aniv),"0年","")
  	...
  	date =string.gsub(date, "%%ib",JST(imasb[imassel[imass]][useidol][1]))
