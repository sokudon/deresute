...
--,{"アイドルマスター スターリットシーズン","2021-10-14T15:00:00.000Z","PS4、steam","",""}
...
function script_properties()
	...
	obs.obs_properties_add_text(props, "ga", "6.学園", obs.OBS_TEXT_DEFAULT)
...
function script_update(settings)
	...
	gan =findidol("ds",cut_string(obs.obs_data_get_string(settings, "ga"),20))
